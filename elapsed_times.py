        ...
        for dataset in self.datasets:
            ...
            for e in self.es:
                ...
                for r in range(self.runs):
                    ...
                    with open(os.path.abspath(os.path.join(os.path.dirname( __file__ ), 'exp', dataset, '%s_executiontime_preprocessing_2.pkl' % ( dataset))), 'rb') as f:
	                    data1_ = pkl.load(f)
...
if __name__ == "__main__":
    ...
    approach = Results(datasets, es, counts, runs)
    approach.run()
