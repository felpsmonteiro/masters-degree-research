...
for e in eps:
    ...
    for path, currentDirectory, files in os.walk(f'Local/{e}'):
        for file in files:
            if file.endswith('.csv'):
                print(f'FOR EPSLON: {e}: Arquivo: {file}')
                traf_d                              = pd.read_csv(f'Local/{e}/{file}', sep=',', nrows = None)
...
path = "Images/ports_mre_gm_results.png"                # path de onde tu quer salvar a imagem
...
epsilons = eps                    # privacy budgets
error_metr = 'mre'                           # mre ou mae, depende do que tu tá medindo
path = "Images/services_mre_gm_results.png"                # path de onde tu quer salvar a imagem
legends = ['Mecanismo Geométrico', 'Abordagem Hierárquica', '2° Pós-Processamento', 'PrivBayes', 'LogLaplace']     # primeira abordagem: mec. geometrico
y = []                                       # erros de diferentes abordagens
...
epsilons = eps                    # privacy budgets
error_metr = 'mre'                           # mre ou mae, depende do que tu tá medindo
path = "Images/protocols_mre_gm_results.png"               # path de onde tu quer salvar a imagem
legends = ['Mecanismo Geométrico', 'Abordagem Hierárquica', '2° Pós-Processamento', 'PrivBayes', 'LogLaplace']     # primeira abordagem: mec. geometrico
y = []                                       # erros de diferentes abordagens
...
path = "Images/ports_mae_gm_results.png"                # path de onde tu quer salvar a imagem
legends = ['Mecanismo Geométrico', 'Abordagem Hierárquica', '2° Pós-Processamento', 'PrivBayes', 'LogLaplace']     # primeira abordagem: mec. geometrico
y = []                                       # erros de diferentes abordagens
...
epsilons = eps                    # privacy budgets
error_metr = 'mae'                           # mre ou mae, depende do que tu tá medindo
path = "Images/services_mae_gm_results.png"                # path de onde tu quer salvar a imagem
legends = ['Mecanismo Geométrico', 'Abordagem Hierárquica', '2° Pós-Processamento', 'PrivBayes', 'LogLaplace']     # primeira abordagem: mec. geometrico
y = []                                       # erros de diferentes abordagens
y.append(mean_mae_pts)                           # erros do geometrico, retornados pela função mre ou mae
...
epsilons = eps                    # privacy budgets
error_metr = 'mae'                           # mre ou mae, depende do que tu tá medindo
path = "Images/protocols_mae_gm_results.png"                # path de onde tu quer salvar a imagem
legends = ['Mecanismo Geométrico', 'Abordagem Hierárquica', '2° Pós-Processamento', 'PrivBayes', 'LogLaplace']     # primeira abordagem: mec. geometrico
y = []                                       # erros de diferentes abordagens
